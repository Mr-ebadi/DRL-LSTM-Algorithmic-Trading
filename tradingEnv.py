...
class TradingEnv(gym.Env):
    ...
    def __init__(self, marketSymbol, startingDate, endingDate, money, stateLength=30,
        ...
        # CASE 2: Real stock loading
            ...
            if(exists):
                ...
                print(self.data)
                self.data["Sentiment"] = SentimentAnalysis.SentimentDS["ts_polarity"].loc[startingDate:endingDate]
                print(self.data)
        ...
        self.state = [self.data['Close'][0:stateLength].tolist(),
                      ...
                      self.data['Sentiment'][0:stateLength].tolist(),
                      [0]]
        self.reward = 0.
        self.done = 0
    ...
    def reset(self):
        ...
        self.state = [self.data['Close'][0:self.stateLength].tolist(),
                      ...
                      self.data['Sentiment'][0:self.stateLength].tolist(),
                      [0]]
        self.reward = 0.
        self.done = 0
    ...
    def step(self, action):
        ...
        self.state = [self.data['Close'][self.t - self.stateLength : self.t].tolist(),
                      ...
                      self.data['Sentiment'][self.t - self.stateLength : self.t].tolist(),
